...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={LDAP, Active Directory, FreeIPA, Kerberos, DNS, Dogtag}, %klicova slova v ceskem jazyce
  keywords.en={LDAP, Active Directory, FreeIPA, Kerberos, DNS, Dogtag}, %klicova slova v anglickem jazyce
  %Abstract
